...
const (
	port_almirante           = ":50059"
	port_broker              = ":50062"
	port_ahsoka              = ":50056"
	path_registro_planetario = "./fulcrum2/registrosPlanetarios/"
	path_log_registro        = "./fulcrum2/logRegistros/"
)
...
func (s *FulcrumServer) CityMgmtFulcrum(ctx context.Context, in *pb.NewCity1) (*pb.RespFulcrum1, error) {
	...
	if pudo_realizar_comando {
		...
		if no_vector_creado {
			created_vector := &pb.Vector{RelojVector: []int32{0, 1, 0}, Planeta: planeta}
